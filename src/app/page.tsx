    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24 bg-green-50">
      ...
      <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left">
        <a
          ...
          className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-green-300 hover:bg-green-100"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm text-gray-600`}>
              Explore the serene beauty of our virtual Zen garden.
            </p>
        </a>
