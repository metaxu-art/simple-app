...
export default function Home() {
 ...
 className="group rounded-lg border border-gray-300 px-5 py-4 transition-colors hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30 mx-1"
 target="_blank"
 rel="noopener noreferrer"
 >
 ...
 <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
 Ask your questions directly to our AI.
 </p>
 </a>
 </div>
 </main>
