...
export default function Home() {
 ...
 className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-red-500 hover:bg-red-500 hover:dark:border-red-700 hover:dark:bg-red-700/30"
 target="_blank"
 rel="noopener noreferrer"
 >
 <h2 className={`mb-3 text-2xl font-semibold`}>Go to Google</h2>
 </a>
 </div>
 </main>
 )
